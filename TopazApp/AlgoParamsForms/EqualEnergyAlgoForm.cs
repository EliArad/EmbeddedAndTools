...
namespace TopazApp.Forms
{
    public partial class EqualEnergyAlgoForm : Form
    {
        ...
        public EqualEnergyAlgoForm(AlgoEqualEnergyParams? d)
        {
            InitializeComponent();
            if (d == null)
            {
        ...
        {
            freqtableform f = new freqtableform(m_params.Value.sid, m_params.Value.RowIndex, "equal energy");
        ...
        {
            EqualEnergyPerDR d = new EqualEnergyPerDR(m_params.Value.sid, m_params.Value.RowIndex, "equal energy");
            d.ShowDialog();
        }
    }
}
