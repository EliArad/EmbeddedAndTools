...
{
    public partial class ThreeCupsTemperaturesForm : Form
    {
        bool m_before;
        int m_testid;

        public ThreeCupsTemperaturesForm(int testid, bool before)
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MySQLConnector.SaveThreeCupTemperatures(m_testid, temp, m_before);
            }
            catch (Exception err)
            {
