...
{
    public partial class NineCupsTemperaturesForm : Form
    {
        bool m_before;
        int m_testid;
        public NineCupsTemperaturesForm(int testid, bool before)
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MySQLConnector.SaveNineCupTemperatures(m_testid, temp, m_before);
            }
            catch (Exception err)
            {
