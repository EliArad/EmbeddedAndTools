...
{
    public partial class FiveCupsTemperaturesForm : Form
    {
        bool m_before;
        int m_testid;
        public FiveCupsTemperaturesForm(int testid, bool before)
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MySQLConnector.SaveFiveCupTemperatures(m_testid, temp, m_before);
            }
            catch (Exception err)
            {
