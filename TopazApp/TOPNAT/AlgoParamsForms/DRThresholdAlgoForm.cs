...
{
    public partial class DRThresholdAlgoForm1 : Form
    {
        AlgoThresholParams ? m_params;

        string freqtableParams = string.Empty;
        public DRThresholdAlgoForm1(AlgoThresholParams ? d)
        {
            InitializeComponent();
            if (d == null)
            {
        ...
        {
            freqtableform1 f = new freqtableform1(m_params.Value.sid, m_params.Value.RowIndex, "DR Treshold");
        ...
        private void DRThresholdAlgoForm1_KeyDown(object sender, KeyEventArgs e)
        {
